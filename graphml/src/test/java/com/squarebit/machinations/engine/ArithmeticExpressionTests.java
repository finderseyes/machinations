...
//        assertThat(AdditionIntegerExpression.of(IntNumber.of(2), IntNumber.of(3)).eval()).isEqualTo(5);
//        assertThat(AdditionIntegerExpression.of(IntNumber.of(9), Negation.of(IntNumber.of(3))).eval()).isEqualTo(6);
...
//                Multiplication.of(
//                        IntNumber.of(4),
//                        AdditionIntegerExpression.of(IntNumber.of(2), IntNumber.of(3))
//                ).eval()
//        ).isEqualTo(20);
//
//        assertThat(
...
//
//        x.set(10);
//        assertThat(AdditionIntegerExpression.of(IntNumber.of(2), xvar).eval()).isEqualTo(12);
//
//        x.set(20);
//        assertThat(AdditionIntegerExpression.of(IntNumber.of(2), xvar).eval()).isEqualTo(22);
//    }
//
...
//
//        assertThat(predicateProbability(
//                () -> AdditionIntegerExpression.of(IntNumber.of(1), ProbableNumber.of(0.0f)).eval() == 2
//        )).isCloseTo(0.0f, Offset.offset(3e-2f));
//
//        assertThat(predicateProbability(
//                () -> AdditionIntegerExpression.of(IntNumber.of(1), ProbableNumber.of(1.0f)).eval() == 2
//        )).isCloseTo(1.0f, Offset.offset(3e-2f));
//
//        assertThat(predicateProbability(
//                () -> AdditionIntegerExpression.of(IntNumber.of(1), ProbableNumber.of(0.75f)).eval() == 2
